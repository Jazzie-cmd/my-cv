...
const Navbar = () => {
  ...
  return (
    ...
    focus:after:origin-right focus:after:scale-x-0">Contact</a></li>
          ...
          <a
            href="#contact"
            className="hidden md:block px-6 py-3 rounded-full bg-gradient-to-r from-cyan-500 to-cyan-400 text-sm font-semibold hover:border border-cyan-400 opacity-100 transition"
          >
            Hire Me!
          </a>
